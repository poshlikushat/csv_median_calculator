...
Приложение читает файлы с историей торгов, вычисляет медиану цен по мере обработки данных и сохраняет результаты в выходной файл.
...
1. Прочитать конфигурацию из TOML-файла
2. Найти все CSV-файлы в указанной директории, соответствующие маскам
3. Прочитать данные из найденных файлов
4. Объединить все записи и отсортировать по `receive_ts`
5. Последовательно обработать записи: добавить цену в аккумулятор, пересчитать медиану
6. Если медиана изменилась — записать строку `receive_ts;price_median` в выходной файл
...
Если у вас возникли вопросы по заданию, вы можете задать вопрос в чате hh.ru.
